...
class Game():
    ...
    def __init__(self, player, grupo_inimigo):
        ...
        self.prox_level = pygame.mixer.Sound('assets/passadenivel.wav')

        self.fonte = pygame.font.Font('assets/fonte.ttf', 24)
        
        #professores
        areia = pygame.image.load('assets/areia.jpg')
        areia = pygame.transform.scale(areia, (64,64))
        builder = pygame.image.load('assets/builder.jpg')
        builder = pygame.transform.scale(builder, (64,64))
        ffjr = pygame.image.load('assets/ffjr.jpg')
        ffjr = pygame.transform.scale(ffjr, (64,64))
        mural = pygame.image.load('assets/mural.jpg')
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.som_entrega = pygame.mixer.Sound('assets/ponto.wav')
        self.som_morte = pygame.mixer.Sound('assets/dano.wav')
        self.som_warp = pygame.mixer.Sound('assets/tp.wav')
        self.som_sem_warp = pygame.mixer.Sound('assets/semtp.wav')
